  ...
  select(event) {
    ...
    this.tabTargets.forEach((tab) => {
      ...
      tab.classList.remove(
        tab.dataset.selectedClass,
        tab.dataset.unselectedClass,
      );
      tab.classList.add(
        isSelected ? tab.dataset.selectedClass : tab.dataset.unselectedClass,
      );
    ...
    this.panelTargets.forEach((panel) => {
      ...
      panel.classList.remove(
        panel.dataset.selectedClass,
        panel.dataset.unselectedClass,
      );
      panel.classList.add(
        isSelected
          ? panel.dataset.selectedClass
