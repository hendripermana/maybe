...
export default class extends Controller {
  ...
  connect() {
    ...
    document.addEventListener("theme:preferenceChanged", this.handlePreferenceChange.bind(this));
  }

  disconnect() {
    document.removeEventListener("theme:preferenceChanged", this.handlePreferenceChange.bind(this));
  }
