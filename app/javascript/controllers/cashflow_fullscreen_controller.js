...
export default class extends Controller {
  ...
  connect() {
    ...
    if (this.hasFullscreenOverlayTarget) {
      console.log(
        "✅ Fullscreen overlay target found:",
        this.fullscreenOverlayTarget,
      );
      console.log("Overlay classes:", this.fullscreenOverlayTarget.className);
    } else {
      console.warn("❌ Fullscreen overlay target NOT found");
      console.log(
        "Available targets in element:",
        this.element.querySelectorAll("[data-cashflow-fullscreen-target]"),
      );
    }
  ...
  get isFullscreen() {
    ...
    console.log(
      "🔍 Checking fullscreen state - hidden class:",
      isHidden,
      "isFullscreen:",
      currentState,
    );
  ...
  toggleFullscreen(event) {
    ...
    console.log(
      "🔄 Toggle fullscreen clicked! Current state:",
      this.isFullscreen,
    );
    ...
    if (!this.hasFullscreenOverlayTarget) {
      console.error(
        "❌ Cannot toggle fullscreen: missing fullscreenOverlay target",
      );
      return;
    }
    ...
    console.log(
      "🎯 Action decision - currently fullscreen:",
      currentlyFullscreen,
    );
  ...
  enterFullscreen() {
    if (!this.hasFullscreenOverlayTarget) {
      console.error(
        "❌ Cannot enter fullscreen: missing fullscreenOverlay target",
      );
      return;
    }
  ...
  exitFullscreen() {
    if (!this.hasFullscreenOverlayTarget) {
      console.error(
        "❌ Cannot exit fullscreen: missing fullscreenOverlay target",
      );
      return;
    }
  ...
  triggerChartRedraw() {
    ...
    const chartElements = this.element.querySelectorAll(
