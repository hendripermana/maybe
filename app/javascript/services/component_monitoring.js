...
export class ComponentMonitoringService {
  ...
  static monitorStimulusControllers() {
    if (window.Stimulus) {
      const originalControllerConnect =
        window.Stimulus.Controller.prototype.connect;
      ...
      const originalControllerDisconnect =
        window.Stimulus.Controller.prototype.disconnect;
